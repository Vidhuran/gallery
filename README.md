...
- gallery-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- gallery-ui: main application module, development time
- gallery-production: module that produces a production mode WAR for deployment
